<template>
    <view class="page">
        ...
        <view v-if="showConfirmBtn" class="page-footer">
...
export default {
    ...
    onLoad(option) {
        ...
        // this.showConfirmBtn = option?.from === 'account'
    ...
    methods: {
        async handleSubmit() {
            ...
            try {
                ...
                this.$toast({ title: '账号开通成功！', icon: 'none' })
                uni.removeStorageSync('contract')
                uni.redirectTo({ url: '/pages/audition/accountSuccess/index' })
            } finally {
                this.loading = false
            }
        }
